...
- `extensions` supports Designer and EDT projects through IBCMD: `--name` selects an
  extension `source-set`, `--installed-name` selects an installed platform name without a matching source-set.
