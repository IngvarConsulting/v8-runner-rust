...
Keep `workPath` outside the dump target directory, including through symlinks; dump rejects a target containing its runtime state. Generated Designer mirrors beneath `workPath` remain supported.
