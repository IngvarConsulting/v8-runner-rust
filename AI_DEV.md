...
не выполнена — задачу в поле `gap`; сегодня так у 29 правил из 154.
...
правят, когда меняется то, что важно снаружи. `scripts/impl-prompt.md` ссылается на скилл с
чужой машины и в маршрут не входит.
