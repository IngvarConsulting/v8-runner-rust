...
- Если новые архитектурные границы не фиксировать [правилами](../../arch/README.md), AI-агенты или новые контрибьюторы могут переинтерпретировать важные решения как случайные детали реализации.
