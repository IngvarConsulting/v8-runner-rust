...
| Безопасная точка | Место, где команда сама проверяет отмену; остановка там ничего не обрывает | `command_boundary`, `use_cases::interruption` |
| Место отмены | Где отмена остановила команду: на границе или посреди работы исполнителя | `CancelledAt` |
