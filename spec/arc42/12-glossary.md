...
| --- | --- | --- |
| Набор исходников | Единица работы: конфигурация, расширение, внешние обработки или отчёты | `source-set`, `SourceSetContext` |
...
| Исполнитель | Кто делает операцию: Конфигуратор, `ibcmd`, агент, `webinst` | `Provider` |
