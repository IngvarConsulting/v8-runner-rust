...
Согласованные гарантии продукта живут правилами в [`spec/rules/`](../rules/README.md):
...
- При изменении гарантии сначала правят её правило в `spec/rules/`, затем — затронутые разделы arc42.
