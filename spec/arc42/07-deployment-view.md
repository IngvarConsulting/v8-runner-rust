...
- Процессы: сам раннер; утилиты — дочерними процессами в своих группах; свой агент
...
- Раннер пишет в `workPath` и в каталог, где лежит цель: промежуточная и резервная копии
