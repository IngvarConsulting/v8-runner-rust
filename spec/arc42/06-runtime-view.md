...
- Отмена или превышение, пока проект ждёт общей сессии: до первой доставленной проверки это
  ошибка протокола, как у недопущенного вызова; после неё — отказ формой `check`, потому что
  работа уже была.
