...
check: [src/platform/process.rs::render_command_masks_the_password_inside_a_connection_string, src/platform/secrets.rs::masks_a_password_quoted_around_a_semicolon, tests/cli_launch.rs::launch_failure_never_echoes_the_password_inside_the_connection_string, tests/cli_launch.rs::launch_dry_run_text_masks_credentials_and_says_nothing_was_dispatched, tests/cli_extensions.rs::extension_preview_never_echoes_the_infobase_password]
scope: [cli, platform]
---
...
превью знает его из конфигурации и маскирует, а показ отказа конфигурации не видит —
см. «Не затрагивает» в решении.
