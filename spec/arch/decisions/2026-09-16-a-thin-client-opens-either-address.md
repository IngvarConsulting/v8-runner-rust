...
supersedes: []
superseded-by: null
establishes: [INV.CLI.A-STANDALONE-CLIENT-GOES-BY-THE-WEB-ADDRESS, INV.CLI.A-NON-THIN-MODE-STILL-REFUSES-A-STANDALONE-TARGET, INV.CLI.VIA-IS-REJECTED-WHERE-THERE-IS-NO-CHOICE, CTR.WIRE.LAUNCH-DATA, CTR.MCP.PUBLISHED-TOOL-SURFACE]
