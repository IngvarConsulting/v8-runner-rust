...
**Почему.** Три команды `syntax designer-config`, `syntax designer-modules` и `syntax
edt` делили одно намерение по инструменту, и вызывающему приходилось знать, чем
