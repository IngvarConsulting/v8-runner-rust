...
14. Довести живую проверку форм `data` до четырёх команд, у которых её пока нет: `bootstrap`,
...
15. Закрыть состав полей у вариантов размеченного перечисления в порождённых формах: schemars
...
16. Свести подпись узла и его знак в одном месте. Сейчас подпись собирает каждый
