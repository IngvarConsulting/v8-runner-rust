...
check:
  - tests/mcp_http.rs::mcp_http_prewarms_the_shared_edt_session_before_the_first_call
...
держит её только в своих границах: `tools.edt_cli.auto-start` прогрева у неё не включает.
