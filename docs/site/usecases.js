...
window.RUNNER_USECASES = [
  ...
  { id: 'release', title: 'Собрать поставку',
    ...
    steps: [
      ...
      { id: 'infobase-save', in: ['ib'], out: ['cf'], note: 'если нужна именно конфигурация базы: основная или та, что в базе данных' }
    ] },
  ...
  { id: 'standalone', title: 'Работа с автономным сервером',
    ...
    steps: [
      { id: 'push', in: ['repo'], out: ['ib', 'state'], note: 'загрузка через шлюз, одной сессией' },
      { id: 'pull', in: ['ib'], out: ['repo'], note: 'выгрузка тем же каналом' },
