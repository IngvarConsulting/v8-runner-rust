...
def general_map(id):
    ...
    d.edge('R', 'RAS', 'поднимает, если cluster.ras не объявлен', path='M100,330 L100,610 Q100,640 130,640 L1185,640 Q1215,640 1215,610 L1215,330 Q1215,300 1185,300 L1095,300', lx=640, ly=640)
