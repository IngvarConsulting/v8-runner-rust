...
Конфигурация выгружается в файлы в **иерархической** раскладке и только в ней: объект
лежит в своём каталоге. Это платформенное умолчание, и раннер его не переопределяет —
аргумент раскладки не передаётся ни пакетному Конфигуратору, ни агентскому shell.
Линейная раскладка (`plain`, объект одним файлом) вне охвата: раннер её не производит,
не берётся читать и не распознаёт. Дерево исходников, выгруженное линейно, обслуживается
не будет — обнаружение изменений по файлам, частичная загрузка списком и сверка выгрузки
с деревом рассчитаны на иерархию.
