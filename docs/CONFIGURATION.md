...
Это формат **исходников**: XML платформы или проект EDT. С раскладкой выгрузки
конфигурации в файлы он не связан и её не выбирает. Раскладка поддерживается одна —
иерархическая, платформенное умолчание; линейная (`plain`) вне охвата, раннер её не
производит и не берётся читать. Ключа для выбора раскладки нет, потому что выбора нет.
